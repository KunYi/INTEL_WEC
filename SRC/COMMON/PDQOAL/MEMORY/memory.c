...
void x86InitMemory()
{
    ...
    OALMSG (OAL_INFO, (L" x86InitMemory(): dwAcpiPHYS = 0x%X\r\n", dwAcpiPHYS));
    ...
    OALMSG (OAL_INFO, (L" x86InitMemory(): dwRamEndPHYS = 0x%x\r\n", dwRamEndPHYS));
    ...
    OALMSG (OAL_INFO, (L" x86InitMemory(): dwRamTop(1)= 0x%x\r\n", dwRamTop));
    ...
    OALMSG (OAL_INFO, (L" x86InitMemory():g_pOemGlobal->dwMainMemoryEndAddress = 0x%x\r\n", 
