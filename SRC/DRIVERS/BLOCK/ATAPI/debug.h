...
#define ZONE_DEPRECATED   DEBUGZONE(ZONEID_DEPRECATED)
...
#define ZONEMASK_DEPRECATED (1 << ZONEID_DEPRECATED)
...
#define CELID_ATAPI_SPTCOMMAND          (CELID_ATAPI_BASE + 19)
#define CELID_ATAPI_SPTRESULT           (CELID_ATAPI_BASE + 20)
#define CELID_ATAPI_DMASPTCOMMAND       (CELID_ATAPI_BASE + 21)
#define CELID_ATAPI_DMASPTRESULT        (CELID_ATAPI_BASE + 22)
