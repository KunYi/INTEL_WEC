...
private:
    CSDHostContainer(const CSDHostContainer &any); // disable copy constructor
    CSDHostContainer& operator=(const CSDHostContainer &any); // disable =   
